...
UI-05	Placar - Jogador X	Valor Numérico	Numérico inteiro (
≥
0
)	0	Exibe o total de vitórias do Jogador X na cor azul.
UI-06	Contador de Rodada	Texto	FormatoAtual/Total (ex: 1/1 ou 1/3)	1/1	Exibe1/1 em Partida Única e atualiza até 3/3 no modo Melhor de 3.
UI-07	Placar - Jogador O / CPU	Valor Numérico	Numérico inteiro (
≥
0
)	0	Exibe o total de vitórias do Jogador O ou Computador na cor laranja.
...
UI-09	Células do Tabuleiro	Botões Grid (
3
×
3
)	Matriz de 9 botões com valores'', 'X' ou 'O'	Todas vazias ('')	Ao clicar, insere o símbolo do jogador atual e desabilita a célula clicada.
...
16.1 Estrutura mínima
 ...
 Tipo do caso de uso informado.
 Atores primário e secundários identificados corretamente.
 Precondições registradas.
 Fluxo principal completo e coerente com o objetivo.
 Fluxos alternativos e de exceção definidos.
 Pós-condições registradas.
 Requisitos não funcionais específicos do CDU registrados.
 Frequência de utilização estimada.
16.2 Qualidade da especificação
 Passos escritos com linguagem simples e objetiva.
 Ações descritas com verbos no presente do indicativo.
 Alternância entre ação do ator e ação da solução está clara.
 Não há ambiguidade relevante.
 Regras de negócio e mensagens foram referenciadas quando necessário.
16.3 Consistência e rastreabilidade
 ...
 Referências internas entre passos estão corretas.
 Interface visual está coerente com o fluxo descrito.
...
RF-02	Seleção de Formato (MD3)	P2, A1.7, A3.1	UI-04 (Seletor de Formato)	Controla limite de vitórias (
vitórias
=
2
) e contador de rodadas.
